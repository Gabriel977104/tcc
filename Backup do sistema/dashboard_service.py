...
def get_youtube_video_info(video_url):
    ...
    try:
        ...
        api_key = 'AIzaSyAhuLhdz2mClfxfxfxgfxgfyxfja54viddeS08'
...
def generate_dashboard_html(analysis_result, job_id):
    ...
    descricoes_sentimentos = {
        ...
        'não identificáveis': 'Quando o sentimento não é claro ou não se enquadra nas categorias.'
    }
...
<body>
    ...
    html_content += f'''
        <div class="kpi-grid">
            ...
            <div class="glass-card kpi-card">
                <div class="kpi-value">{resumo.get('categoria_predominante', 'N/A').title()}</div>
                <div class="kpi-label">Categoria Principal ({resumo.get('porcentagem_predominante', 0):.1f}%)</div>
            </div>
            <div class="glass-card kpi-card">
